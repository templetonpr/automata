...
/***/ function(module, exports, __webpack_require__) {
	...
	var _CellGrid = __webpack_require__(298);
	
	var _CellGrid2 = _interopRequireDefault(_CellGrid);
	
	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
	
	var seedInput = document.getElementById('seed');
	var ruleInput = document.getElementById('ruleNum');
	...
	genButton.addEventListener('click', function (e) {
	  ...
	  var grid = new _CellGrid2.default(options);
...
/***/ function(module, exports) {
	...
	var CellGrid = function () {
	  function CellGrid(options) {
	    _classCallCheck(this, CellGrid);
	
	    this.options = options;
	  }
	
	  _createClass(CellGrid, [{
	    key: 'createGrid',
	    value: function createGrid() {
	      ...
	      while (grid.length < firstRow.length) {
	        ...
	        var prevState = grid.length ? grid[grid.length - 1] : firstRow;
	        var nextState = this._createRow(prevState, ruleset);
	        grid.push(nextState);
	      }
	    ...
	    key: 'drawGrid',
	    value: function drawGrid(canvas, ctx) {
	    ...
	    key: '_createRow',
	    value: function _createRow(inputState, ruleset) {
	      // called by createGrid to generate each new row from an input and ruleset
	
	      return inputState.map(function (center, i, arr) {
	        var left = null;
	        var right = null;
	        ...
	        var rule = [left ? "1" : "0", right ? "1" : "0", center ? "1" : "0"].join("");
	    ...
	    get: function get() {
	      ...
	      var ruleNum = parseInt(this.options.ruleNum);
	
	      // convert to base2 and split each digit
	      var ruleset = ruleNum.toString(2).split("");
	    ...
	    get: function get() {
	      ...
	      //
	      var seedString = this.options.seedString;
	
	      // generate an array of boolean values from a string
	      var boolArray = seedString.split("") // ----------------------- // split the string
	      .map(function (x) {
	        return x.charCodeAt(0);
	      }) // ------- // transform each char into it's charCode
	      .reduce(function (a, b) {
	        return a + b;
	      }) // --------- // sum the charCodes
	      ...
	      }); // transform the bin vals to booleans
